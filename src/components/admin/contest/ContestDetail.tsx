        ...
        <div className="flex justify-between items-center  px-16 ">
          ...
          <div className="flex items-center gap-2">
            <IoAlertCircleOutline
              ...
              onClick={() => {
                router.push(`/admin/contest/enrollannouncement/${contestId}`);
              }}
            />
            <MdOutlineLibraryAdd
              className="text-lg cursor-pointer lg:text-2xl hover:text-gray-500"
              onClick={() => {
                router.push(`/admin/contest/enrollproblem/${contestId}`);
              }}
            />
            <RiUserAddLine
              className="text-lg cursor-pointer lg:text-2xl hover:text-gray-500"
              onClick={() => {
                router.push(`/admin/contest/enrolluser/${contestId}`);
              }}
            />
            ...
            <TbEdit
              className="text-lg cursor-pointer lg:text-2xl hover:text-gray-500"
              onClick={() => {
                router.push(`/admin/contest/edit/${contestId}`);
              }}
            />
            <FiTrash2
              className="text-lg cursor-pointer lg:text-2xl hover:text-gray-500"
