...
export default function AssignmentEdit() {
  ...
  useEffect(() => {
    if (assignmentInformation) {
      ...
      reset({
        ...
        type: assignmentInformation.data.type,
      });
    }
  ...
  const mutation = useMutation({
    ...
    onSuccess: () => {
      message.success('과제가 성공적으로 수정되었습니다.');
      refetch();
          ...
          <section className="flex flex-col text-sm">
            <div className="flex flex-col justify-center px-10 py-4 border-b-[1.5px] border-gray-200">
              <div className="flex items-center">
                <label htmlFor="assignment-name">과제 이름:</label>
                <input
                  {...register('title')}
            ...
            <div className="flex flex-col justify-center px-10 py-4 border-b-[1.5px] border-gray-200">
              <div className="flex items-center">
                <label htmlFor="assignment-description">과제 설명:</label>
                <input
