...
import { postReSubmitContest } from '@/services/submissionAdmin/postReSubmitContest';
import { formattedDate } from '@/utils/dateFormatter';
import CircularProgress from '@mui/material/CircularProgress';
import { getAllSubmissionContest } from '@/services/submissionAdmin/getAllSubmissionContest';
...
export default function SubmissionList({
  ...
  const {
    ...
    queryKey: ['submissionListData', currentPage, contestId, problemId],
    queryFn: () => getAllSubmissionContest(currentPage, contestId, problemId),
  });

  useEffect(() => {
    router.push(
      `/professor/contest/submission/${contestId}/${problemId}?page=${currentPage}`,
    );
    refetch();
  ...
  const reSubmitMutation = useMutation({
    mutationFn: (id: string) => postReSubmitContest(contestId, problemId, id),
    onMutate: () => {
