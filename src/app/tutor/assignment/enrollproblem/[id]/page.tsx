...
export default function ProblemEnroll() {
  ...
  //     null,
  //     '',
  //     `/tutor/assignment/enrollproblem/${assignmentId}?page=${page}`,
  //   );
  //   setCurrentPage(page);
  // };
  ...
  useEffect(() => {
    ...
    window.history.replaceState(
      null,
      '',
      `/tutor/assignment/enrollproblem/${assignmentId}?${query.toString()}`,
    );
    refetch();
  }, [
    currentPage,
  ...
  const closeModal = () => {
    ...
    const newUrl = `/tutor/assignment/enrollproblem/${assignmentId}`;
      ...
      <div className="space-y-8">
        <div className="w-full h-full py-8 font-semibold bg-white shadow-lg rounded-3xl text-secondary">
          <section className="flex flex-col sm:flex-row items-center px-16">
            <h1 className="text-lg">퀴즈 문제 관리</h1>
          </section>
          ...
          >
            ...
            <div className="flex items-center gap-2">
              ...
              >
                ...
                <Option value={'other'}>대회/퀴즈</Option>
              </Select>
