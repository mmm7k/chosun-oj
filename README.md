...
> **실시간 저지 및 웹 IDE를 갖춘 온라인 저지 시스템** <br/> **개발기간: 2024** <br/> **1인 개발** <br/> **배포: 자체 서버 (http://chosuncnl.shop:5555)** <br/> **사용 기술 <br/> - Next.js (ver.14) <br/> - TypeScript <br/> - Zustand <br/> - React Query(v.5)**  
