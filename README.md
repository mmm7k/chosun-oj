...
조선대학교 온라인 저지 시스템은 학생, 교수, 관리자용 페이지를 포함한 **종합 온라인 저지 플랫폼**입니다.<br/> 웹 기반의 **IDE**를 통해 코드 작성 및 실시간 컴파일이 가능하며, 과제 제출, 대회 참여, Q&A, 공지사항 확인, 랭킹 시스템을 제공합니다.<br/> 모든 CRUD 기능은 React Query를 사용해 **효율적으로 최적화**되었으며, 로그인상태를 **Zustand를 통해 전역으로 관리**하였습니다.
